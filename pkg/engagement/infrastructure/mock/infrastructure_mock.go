...
func (f *FakeInfrastructure) SaveMarketingMessage(
	ctx context.Context,
	data dto.MarketingSMS,
) (*dto.MarketingSMS, error) {
...
func (f *FakeInfrastructure) UpdateMarketingMessage(
	ctx context.Context,
	data *dto.MarketingSMS,
) (*dto.MarketingSMS, error) {
...
// UpdateUserCRMEmail ..
func (f *FakeInfrastructure) UpdateUserCRMEmail(ctx context.Context, phoneNumber string, payload *dto.UpdateContactPSMessage) error {
	return f.UpdateUserCRMEmailFn(ctx, phoneNumber, payload)
}

// UpdateUserCRMBewellAware ..
func (f *FakeInfrastructure) UpdateUserCRMBewellAware(ctx context.Context, email string, payload *dto.UpdateContactPSMessage) error {
	return f.UpdateUserCRMBewellAwareFn(ctx, email, payload)
}

// GetMarketingSMSByPhone ..
func (f *FakeInfrastructure) GetMarketingSMSByPhone(ctx context.Context, phoneNumber string) (*dto.MarketingSMS, error) {
	return f.GetMarketingSMSByPhoneFn(ctx, phoneNumber)
}

// GetMarketingSMSByID ..
func (f *FakeInfrastructure) GetMarketingSMSByID(
	ctx context.Context,
	id string,
) (*dto.MarketingSMS, error) {
...
func (f *FakeInfrastructure) NotifyEngagementCreate(
	ctx context.Context,
	phone string,
	messageID string,
	engagementType crmDomain.EngagementType,
