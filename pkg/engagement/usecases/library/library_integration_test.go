...
func InitializeTestNewLibrary(ctx context.Context) (*library.ImplLibrary, infrastructure.Interactor, error) {
	infra := infrastructure.NewInteractor()
	lib := library.NewLibrary(infra)
	return lib, infra, nil
}

func TestNewLibraryService(t *testing.T) {
	ctx := context.Background()
	f, i, err := InitializeTestNewLibrary(ctx)
	if err != nil {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := library.NewLibrary(tt.args.infrastructure); !reflect.DeepEqual(got, tt.want) {
...
func TestService_GetFeedContent(t *testing.T) {
	...
	f, _, err := InitializeTestNewLibrary(ctx)
	if err != nil {
		t.Errorf("failed to initialize new Library: %v", err)
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := f.GetFeedContent(tt.args.ctx, tt.args.flavour)
...
func TestService_GetFaqsContent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := f.GetFaqsContent(tt.args.ctx, tt.args.flavour)
			if (err != nil) != tt.wantErr {
...
func TestService_GetLibraryContent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := f.GetLibraryContent(tt.args.ctx)
			if (err != nil) != tt.wantErr {
